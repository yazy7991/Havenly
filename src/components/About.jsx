...
export default function About() {
  return (
    ...
    id='About'>
        ...
        '>
            About <span className='underline underline-offset-4
            decoration-1 under font-light '>Our Brand</span>
        </h1>
        ...
        md:items-start md:gap-20'>
            ...
            text-gray-600'>
                ...
                <p className='my-10 max-w-lg'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. 
                    Voluptatem exercitationem molestias incidunt dolorum provident fugit, accusamus minus, reprehenderit aliquid fuga unde 
                    officiis obcaecati recusandae. Iusto, totam. 
                    Id earum numquam sunt!
                </p>
